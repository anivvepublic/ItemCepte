    ...
    <div className="relative pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
        <div className="animate-fadeInUp">
          <div className="inline-flex items-center gap-2 bg-[#22C55E]/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6 border border-[#22C55E]/30">
            <span className="w-2 h-2 bg-[#22C55E] rounded-full animate-pulse"></span>
            <span className="text-xs text-[#22C55E] font-medium">Güvenli Ödeme & Hızlı Teslimat</span>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight">
            ...
            <br />
            <span className="neon-text">En Güvenilir Adresi</span>
          </h1>
          ...
          <button 
            ...
            className="btn-primary-glow text-lg px-8 py-3 group"
          >
