          ...
          <>
            ...
            {mode !== 'reset' && (
              <>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 bg-[#1F2937] hover:bg-[#374151] border border-[#374151] rounded-xl py-2.5 transition"
                >
                  ...
                  <span className="text-sm text-white">Google ile devam</span>
                </button>
              </>
            )}
            ...
            {mode === 'login' && (
              <p className="text-center text-sm text-[#9CA3AF] mt-5">
                Hesabın yok mu?{' '}
                <button onClick={() => setMode('register')} className="text-[#10B981] hover:underline">Kayıt ol</button>
              </p>
            )}
            {mode === 'register' && (
              <p className="text-center text-sm text-[#9CA3AF] mt-5">
                Zaten hesabın var mı?{' '}
                <button onClick={() => setMode('login')} className="text-[#10B981] hover:underline">Giriş yap</button>
              </p>
            )}
          </>
        )}
